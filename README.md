...
<h5 align="center">Based on the work by @theztefan, @lcartey, @rvermeulen</h3>
...
Welcome to the workshop CodeQL tailoring - One size does not always fit all!
...
2. Refine the set of results by limiting it to methods named `getAverageRating`, that accept two parameters where the first parameter is named `fromsql`.
   <details>
   <summary>Hints</summary>
...
5. Extend the query to find all the parameters of the just found public methods.
